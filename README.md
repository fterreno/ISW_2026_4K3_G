...
Establecemos como criterio que la línea base se creará tras la entrega y revisión de cada Trabajo Práctico (TP) evaluable, cuando los ítems de configuración asociados estén completos y estables. Esto asegura que el repositorio se encuentre actualizado y con información validada por todos los integrantes.

Las líneas base se identificarán con la siguiente etiqueta: `linea_base_<nro>`.
...
| --- | --- | --- |
| `linea_base_1` | DD/MM/AAAA | *(Ejemplo: Entrega y revisión del TP N°4 de SCM)* |
